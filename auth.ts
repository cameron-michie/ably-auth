...
const PORT = parseInt(process.env.AUTH_SERVER_PORT || '3000');
...
const server = http.createServer(async (req, res) => {
  ...
  const userFullName = req.headers['x-user-full-name'] as string;
...
export function startAuthServer(): Promise<http.Server> {
